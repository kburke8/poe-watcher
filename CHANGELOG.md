...
- Speedrun timer with start/pause/reset via Ctrl+Space
- Automatic log file monitoring (Client.txt)
...
- Split comparison charts (bar and line)
- Town and hideout time tracking
- Auto-updater via GitHub Releases
- Global hotkeys (Ctrl+Space, Ctrl+Shift+Space, Alt+Space)
